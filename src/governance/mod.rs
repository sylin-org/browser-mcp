...
//! renderer ([`explain`]), the policy manifest ([`manifest`]), the audit flight recorder
...
//! audit, manifest identity, and denial ids). A fail-closed arch-test (task A7) enforces that.
