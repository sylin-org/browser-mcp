...
//! enforcement pre/post-dispatch checks), and the read/write classification table
//! ([`classify`], the plugin half of [`crate::governance::ports::DomainPolicy::classify`]; the
//! observe/mutate axis type itself is core). It may depend on the governance core and on
