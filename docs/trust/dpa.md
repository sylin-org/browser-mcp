...
processes no customer personal data. Its brevity is the point. It is shaped against the Common
Paper Data Processing Agreement v1.1 (a counsel-drafted standard form published under CC BY
4.0), which itself contemplates deployments where processing terms default to "none" or "not
applicable"; Ghostlight is that case, stated plainly rather than left as blank fields.
